...
public final class TestHelper {
     ...
     */
    @SuppressWarnings("unchecked")
    public static <T> void injectMock(Object obj, final Object mockObject, final String fieldName) {
        try {
            ...
            LOGGER.error(String.format("Failed to inject %s into %s using fieldname %s", mockObject,
                    obj, fieldName), e);
        }
    }
}
